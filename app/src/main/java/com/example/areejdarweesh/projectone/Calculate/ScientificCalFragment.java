...
import com.example.areejdarweesh.projectone.history.DBHelper;
import com.example.areejdarweesh.projectone.history.History;

/**
 * Created by Areej darweesh on 4/15/2019.
 */

public class ScientificCalFragment extends android.support.v4.app.Fragment{
    @Nullable
    ...
    private Button mode,toggle,square,xpowy,log,sin,cos,pii,tan,sqrt,history,clearr,backspace,equall,open,close,mult,pluss,min,div,fact,num00,num11,num22,doot,num33,num44,num55,num66,num77,num88,num99;
    private int toggleMode=1;
    private int angleMode=1;
    View.OnClickListener onClickListener;
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.scientitific_cal, container, false);
    ...
    private void findId(View view){
        ...
        xpowy =view. findViewById(R.id.xpowy);
        ...
        num00=view.findViewById(R.id.num0);
        num11=view.findViewById(R.id.num1);
        num22=view.findViewById(R.id.num2);
        num33=view.findViewById(R.id.num3);
        num44=view.findViewById(R.id.num4);
        num55=view.findViewById(R.id.num5);
        num66=view.findViewById(R.id.num6);
        num77=view.findViewById(R.id.num7);
        num88=view.findViewById(R.id.num8);
        num99=view.findViewById(R.id.num9);
        pii=view.findViewById(R.id.pi);
        doot=view.findViewById(R.id.dot);
        clearr=view.findViewById(R.id.clear);
        backspace=view.findViewById(R.id.backSpace);
        mult=view.findViewById(R.id.multiply);
        pluss=view.findViewById(R.id.plus);
        min=view.findViewById(R.id.minus);
        div=view.findViewById(R.id.divide);
        equall=view.findViewById(R.id.equal);
        open=view.findViewById(R.id.openBracket);
        close=view.findViewById(R.id.closeBracket);
    ...
    public void onclick1() {
        ...
        xpowy.setOnClickListener(onClickListener);
        log.setOnClickListener(onClickListener);
        sin.setOnClickListener(onClickListener);
        cos.setOnClickListener(onClickListener);
        tan.setOnClickListener(onClickListener);
        sqrt.setOnClickListener(onClickListener);
        fact.setOnClickListener(onClickListener);
        num00.setOnClickListener(onClickListener);
        num11.setOnClickListener(onClickListener);
        num22.setOnClickListener(onClickListener);
        num33.setOnClickListener(onClickListener);
        num44.setOnClickListener(onClickListener);
        num55.setOnClickListener(onClickListener);
        num66.setOnClickListener(onClickListener);
        num77.setOnClickListener(onClickListener);
        num88.setOnClickListener(onClickListener);
        num99.setOnClickListener(onClickListener);
        pii.setOnClickListener(onClickListener);
        doot.setOnClickListener(onClickListener);
        clearr.setOnClickListener(onClickListener);
        backspace.setOnClickListener(onClickListener);
        div.setOnClickListener(onClickListener);
        min.setOnClickListener(onClickListener);
        pluss.setOnClickListener(onClickListener);
        mult.setOnClickListener(onClickListener);
        equall.setOnClickListener(onClickListener);
