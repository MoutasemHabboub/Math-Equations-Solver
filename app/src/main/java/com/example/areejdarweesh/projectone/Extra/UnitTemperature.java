...
public class UnitTemperature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this, R.array.temperature, R.layout.my_spinner_item);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);
        s1.setAdapter(adapter);
        ArrayAdapter adapter2 = ArrayAdapter.createFromResource(this, R.array.temperature, R.layout.my_spinner_item);
