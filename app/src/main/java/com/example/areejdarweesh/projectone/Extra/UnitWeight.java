...
public class UnitWeight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setSupportActionBar(toolbar);
        ...
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this, R.array.weight, R.layout.my_spinner_item);
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);
        s1.setAdapter(adapter);
        ArrayAdapter adapter2 = ArrayAdapter.createFromResource(this, R.array.weight, R.layout.my_spinner_item);
